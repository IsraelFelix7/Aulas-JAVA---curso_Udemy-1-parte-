...
public class Program {
	...
	public static void main(String[] args) {
		...
		List<String> resultado = lista.stream().filter(x -> x.charAt(0) == 'j').collect(Collectors.toList()); // esta pesquisa é para deixar na lista apenas       
																												// nomes que começam com a letra 'j' no começo
		for(String newList: resultado) {
